...
@dp.table(name="retail_proj.retail_gold.fact_sales")
def fact_sales():
    transactions_df = spark.read.table("retail_proj.retail_silver.transactions")
    opportunity_df = spark.read.table("retail_proj.retail_silver.opportunity")
